...
exports.createUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userExists, _a, newUser, results, dataUser, dataUserJson, token;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                _a = req.body;
                return [4 /*yield*/, User_1.User.encrypPassword(req.body.password)];
            case 2:
                _a.password = _b.sent();
            ...
            case 4:
                results = _b.sent();
                dataUser = JSON.stringify(results);
