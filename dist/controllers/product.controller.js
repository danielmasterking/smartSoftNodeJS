...
exports.searchProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(req.body.search != null)) return [3 /*break*/, 2];
                return [4 /*yield*/, typeorm_1.getRepository(Product_1.Product).find({
                        nombre: typeorm_2.Like("%" + req.body.search + "%")
                    })];
            case 1:
                data = _a.sent();
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, typeorm_1.getRepository(Product_1.Product).find()];
            case 3:
                data = _a.sent();
                _a.label = 4;
            case 4: return [2 /*return*/, res.json(data)];
        }
    });
}); };
