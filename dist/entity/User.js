...
var User = /** @class */ (function () {
    ...
    User.encrypPassword = function (password) {
    ...
    User.validatePassword = function (password, passwordBd) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, bcryptjs_1.default.compare(password, passwordBd)];
